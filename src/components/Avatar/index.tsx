...
const Avatar = ({ alt, src, onClick, size, className }: AvatarProps) => {
    ...
    <>
      {src ? (
        <img
          ...
          src={src}
          onClick={onClick}
          className={`w-10 h-10 min-h-10 min-w-10 rounded-full object-fill ${className}`}
          style={style}
        />
      ) : (
        <svg
        ...
        >
          <path
            className='fill-[#F0F2F5] dark:fill-[#6A7175]'
          ...
          <g>
            <path
              className='fill-[#FFFFFF] dark:fill-[#CFD4D6]'
